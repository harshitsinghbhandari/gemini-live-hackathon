...
const PinGate = ({ children, backendUrl }) => {
    ...
    return (
        <div className="flex min-h-screen items-center justify-center bg-[#0a0a0f] font-display antialiased px-6">
            <div className="w-full max-w-sm">
                <div className="bg-slate-900/40 backdrop-blur-xl border border-slate-800 rounded-2xl p-8 shadow-2xl relative overflow-hidden">
                    ...
                    <div className="flex flex-col items-center mb-8">
                        <div className="text-[#7c3aed] text-4xl mb-4 animate-in zoom-in duration-500">
                    ...
                    <form onSubmit={handleUnlock} className="space-y-4">
                        ...
                        {error && (
                            <div className="bg-red-500/10 border border-red-500/20 text-red-500 text-[10px] font-mono uppercase tracking-widest text-center py-2 rounded-lg animate-in fade-in slide-in-from-top-1">
                                {error}
                            </div>
                        )}
